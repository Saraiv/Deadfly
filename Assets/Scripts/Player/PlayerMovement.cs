...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void StateHandler()
    {
        ...
        bool desiredMovementSpeedhasChanged = desiredMoveSpeed != lastDesiredMoveSpeed;
    ...
    private IEnumerator SmoothlyLerpMoveSpeed()
    {
        ...
        float boosterFactor = speedChangeFactor;

        while(time < difference) 
        {
            moveSpeed = Mathf.Lerp(startValue, desiredMoveSpeed, time / difference);

            time += Time.deltaTime * boosterFactor;
    ...
    private void MovePLayer()
    {
        ...
        //in air
            ...
            rb.AddForce(moveDirection.normalized * airMultiplier * 20f, ForceMode.Force);
